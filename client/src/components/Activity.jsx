          ...
          {isActive ? (
            <div className="space-y-6">
              ...
              <div className="flex justify-between">
                <button
                  className={`px-3 py-1 text-sm border border-gray-300 rounded-md ${currentStep === 0 ? "opacity-50 cursor-not-allowed" : ""
                    }`}
                  onClick={prevStep}
                ...
                <button
                  className={`px-3 py-1 text-sm border border-gray-300 rounded-md ${currentStep === activity.instructions.length - 1
