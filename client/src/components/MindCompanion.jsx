...
const MindCompanion = () => {
  ...
  const openGamePopup = gameType => {
    ...
    popup.document.body.innerHTML = `
      <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; background: ${isDarkTheme ? "#1F2937" : "#F3F4F6"
  ...
  return (
    <div
      className={`flex min-h-screen ${isDarkTheme ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"
        }`}
    >
      {/* Sidebar */}
      <aside className="w-64 bg-white dark:bg-gray-800 border-r dark:border-gray-700 flex flex-col fixed h-full">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <button
            className={`w-full text-left px-4 py-2 rounded-md ${activeSection === "postsSection"
          ...
          <button
            className={`w-full text-left px-4 py-2 rounded-md ${activeSection === "chatSection"
                ? "bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-200"
                : "hover:bg-gray-100 dark:hover:bg-gray-700"
              }`}
          ...
          <button
            className={`w-full text-left px-4 py-2 rounded-md ${activeSection === "gamesSection"
                ? "bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-200"
                : "hover:bg-gray-100 dark:hover:bg-gray-700"
              }`}
          ...
          <button
            className={`w-full text-left px-4 py-2 rounded-md ${activeSection === "whatsappSection"
                ? "bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-200"
                : "hover:bg-gray-100 dark:hover:bg-gray-700"
              }`}
